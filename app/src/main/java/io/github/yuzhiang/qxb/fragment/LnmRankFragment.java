...
import io.github.yuzhiang.qxb.databinding.LnmFragmentRankBinding;
...
public class LnmRankFragment extends LazyFragment {
    ...
    public static LnmRankFragment newInstance() {
        return new LnmRankFragment();
    }
    ...
    private LnmFragmentRankBinding binding;


    @Override
    protected int getContentViewId() {
        return R.layout.lnm_fragment_rank;
    }
    ...
    protected void initView(View view) {
        ...
        LogUtils.i("lnmRank======initView");

        mContext = getContext();

        binding = LnmFragmentRankBinding.bind(view);
