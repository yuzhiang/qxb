...
public class PickerLayoutManager extends LinearLayoutManager {
    ...
    private final boolean mMoreHalf;

    private RecyclerView mRecyclerView;
    private OnPickerListener mListener;

    private PickerLayoutManager(Context context, int orientation, boolean reverseLayout, boolean padding, boolean moreHalf, int maxItem, float scale, boolean alpha) {
    ...
    public void onMeasure(@NonNull RecyclerView.Recycler recycler, @NonNull RecyclerView.State state, int widthSpec, int heightSpec) {
        ...
        if (state.getItemCount() != 0 && mMaxItem != 0) {
            ...
            if (mOrientation == HORIZONTAL) {
                ...
                width = measuredWidth * mMaxItem + measuredWidth / 2;
    ...
    public static final class Builder {
        ...
        private boolean mPadding = true;
        private boolean mMoreHalf = false;
        private OnPickerListener mListener;
         ...
         * 设置多显示一半，防止用户不知道可以滑动
         */
        public Builder setShowMoreHalf(boolean moreHalf) {
            mMoreHalf = moreHalf;
            return this;
        }
        ...
        public PickerLayoutManager build() {
            PickerLayoutManager layoutManager = new PickerLayoutManager(mContext, mOrientation, mReverseLayout, mPadding, mMoreHalf, mMaxItem, mScale, mAlpha);
            if (mListener != null) {
        ...
        public PickerLayoutManager build(int maxItem) {
            mMaxItem = maxItem;
            PickerLayoutManager layoutManager = new PickerLayoutManager(mContext, mOrientation, mReverseLayout, mPadding, mMoreHalf, mMaxItem, mScale, mAlpha);
            if (mListener != null) {
                layoutManager.setOnPickerListener(mListener);
        ...
        public PickerLayoutManager build(int maxItem, boolean moreHalf, boolean padding, float scale) {
            mMaxItem = maxItem;
            mScale = scale;
            mPadding = padding;
            mMoreHalf = moreHalf;
