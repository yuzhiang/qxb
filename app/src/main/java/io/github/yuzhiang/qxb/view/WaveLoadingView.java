package io.github.yuzhiang.qxb.view;
...
//        mWaveShader = null;
    ...
    public void setTopTitleColor(int topTitleColor) {
        if (mTopTitlePaint.getColor() != topTitleColor)//防止卡顿
    ...
    public void setCenterTitleColor(int centerTitleColor) {
        if (mCenterTitlePaint.getColor() != centerTitleColor)//防止卡顿
    ...
    public void setBottomTitleColor(int bottomTitleColor) {
        if (mBottomTitlePaint.getColor() != bottomTitleColor)//防止卡顿
